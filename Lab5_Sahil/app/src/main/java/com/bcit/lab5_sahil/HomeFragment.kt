...
class HomeFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val goToArenaButton = v.findViewById<Button>(R.id.button_homefragment)
        val HomeFragtextView : TextView = v.findViewById(R.id.textView_homeFragment)

        HomeFragtextView.text = "Star Wars Battle Arena"

        goToArenaButton.setOnClickListener{
